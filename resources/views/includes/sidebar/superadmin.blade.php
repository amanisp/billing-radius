 <li class="sidebar-item   {{ Route::is('mitra.index') ? 'active' : '' }}">
     <a href="{{ route('maps.index') }}" class='sidebar-link '>
         <i class="fa-solid fa-users"></i>
         <span>Customer</span>
     </a>
 </li>
 <li class="sidebar-item {{ Route::is('freeradius.index') ? 'active' : '' }} ">
     <a href="{{ route('freeradius.index') }}" class='sidebar-link '>
         <i class="fa-solid fa-server"></i>
         <span>Akses Freeradius</span>
     </a>
